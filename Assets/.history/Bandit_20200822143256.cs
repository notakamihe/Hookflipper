...
{
    public AnimatorController fighterAnimCtrlr;
    public Enemy enemy;
    ...
    void Update()
    {
        ...
        if (gun == null)
        {
            ...
            this.gameObject.AddComponent<Fighter>();
            enemy.animator.runtimeAnimatorController = fighterAnimCtrlr as RuntimeAnimatorController;
        }
